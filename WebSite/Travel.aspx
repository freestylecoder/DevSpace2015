<%@ Page Title="" Language="C#" MasterPageFile="~/DevSpace.Master" AutoEventWireup="true" CodeBehind="Travel.aspx.cs" Inherits="DevSpace.Travel" %>
	...
	<section>
		<article>
			...
			<p>
				...
				You can book your room uses the link below.
				Optionally, you can use your preferred method with the group code 'DSC'.
			</p>
			<p>
				<a href="http://embassysuites.hilton.com/en/es/groups/personalized/H/HSVESES-DSC-20151008/index.jhtml?WT.mc_id=POG" target="esh">http://embassysuites.hilton.com/en/es/groups/personalized/H/HSVESES-DSC-20151008/index.jhtml?WT.mc_id=POG</a>
			</p>
		</article>
	</section>
</asp:Content>
