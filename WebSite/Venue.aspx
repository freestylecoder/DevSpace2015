...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
	<section>
		<article>
			<h1>Our Venue (Hopefully)</h1>
			<h2>
				Von Braun Center<br />
				700 Monroe Street<br />
				Huntsville, AL 35801
			</h2>
			<p>DevSpace is hopefully taking place at The Von Braun Center. We are still working with our sponsors to secure the funds to officially lock in the location and date. Look for details on the room block coming soon.</p>
